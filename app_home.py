...
if LOGO_PATH.exists():
    try:
        ...
        st.markdown(
            f"""
            <div class="home-logo">
                <img src="data:image/png;base64,{logo_base64}" alt="TMF LOGISTICS">
            </div>
            """,
            unsafe_allow_html=True,
        )
...
st.write(
    ...
    Cette application permet de centraliser et de suivre les principales données liées à l'activité de transport.
    """
)
...
with col1:
    st.markdown(
        """
        ### 📋 Ordres de Mission
        Gestion et suivi des ordres de mission, des trajets, des camions, des chauffeurs, des clients et des kilométrages.
        """
    )
    ...
    st.markdown(
        """
        ### 🚚 Gestion du parc
        Suivi des camions, remorques, affectations et disponibilité du parc.
        """
    )
    ...
    st.markdown(
        ...
        Gestion des chauffeurs, matricules, fonctions, affectations et superviseurs.
        """
    )
...
with col2:
    st.markdown(
        """
        ### 👥 Gestion des Clients
        Gestion des clients, informations commerciales, coordonnées et lieux de chargement.
        """
    )
    ...
    st.markdown(
        """
        ### 📊 Rapports
        Analyse des données de transport, indicateurs de gestion, performance des chauffeurs et utilisation de la flotte.
        """
    )
    ...
    st.markdown(
        """
        ### 🔄 Données actualisées
        Les données sont récupérées directement depuis les fichiers Excel présents dans le dossier **Data**.
        """
    )
...
st.info(
    ...
    Pour obtenir les dernières données des fichiers Excel, modifiez et enregistrez vos fichiers dans le dossier **Data**, puis cliquez sur **🔄 Actualiser les données**.
    """
)
